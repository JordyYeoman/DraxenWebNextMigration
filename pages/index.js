...
export default () => {
  ...
  return (
    <div className="antialiased text-gray-900">
      {/* // Hero Section */}
      <div class="pt-24 pb-56 relative xl:pb-64 xl:pt-40">
        <img
          class="absolute top-0 h-full w-full object-cover object-top"
          src="/assets/mechDraven.jpg"
        />
        <div class="relative container px-4 mx-auto flex flex-wrap flex-col md:flex-row items-center md:px-6 lg:px-8 z-10">
          <div class="flex flex-col pl-8 w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <p class="leading-normal text-xl mb-8 text-white">
              Join the team today, where anything is possible.
            </p>

            <a
              href="https://www.youtube.com/user/MakinGainzzz?sub_confirmation=1"
              target="_blank"
              rel="noopener noreferrer"
              class="btn mx-auto lg:mx-0 hover:underline text-white-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg"
            >
              Subscribe
            </a>
          </div>
          ...
          <div class="w-full md:w-3/5 py-6 text-center">
            <img
              class="w-full md:w-2/3 pl-16 z-50"
      ...
      <div class="relative -mt-40 xl:-mt-56">
        <svg
      ...
      <section class="relative bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
          ...
          <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
              <h2 class="text-4xl text-gray-800 font-bold leading-none mb-3">
                Places to go, me to see...
              </h2>
              <p class="text-gray-600 mb-8">
                Don't be jealous, many mere mortals have fallen to my glorious
                axes. Seriously, isn't Draven just the coolest champion in this
                whole damn game. No fancy tricks, OP abilities, 400 dashes,
                insta-full health one hit - full armour carry..... just...
                purity.
              </p>
            </div>
            ...
            <div class="w-full sm:w-1/2 p-6 mt-6">
              <div class="align-middle">
                ...
                <p class="text-gray-600 mb-4">
                  Are you an Ezreal one trick?
                  <br></br>
                  Do you like cuddling with your mum on the couch?
                  <br></br>
                  Get yourself up, dust off the chip crumbs from your sweaty
                  beer belly.
                  <br></br>
                  Remove yourself from these beta-ass champions, play Draven and
                  soothe your poor innocent soul. You know full well that
                  abusing cockroaches like Ka-sai &amp; Aphelios just feels
                  wrong. You feel weaker after every game, like you need to drop
                  to the floor and do 100 push-ups just to try regain 10% of
                  your manliness. Yet you lock in another Aphelios game with
                  your boyfriend holding your hand the whole way as he
                  insta-locks Yuumi.
                </p>
                <h4 className="font-semibold">ENOUGH.</h4>
              </div>
            </div>
          </div>
          <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
              <h2 class="text-4xl text-gray-800 font-bold leading-none mb-3">
                Go out,<br></br> GET SOME
              </h2>
              <p class="text-gray-600 mb-4">
                I don't want to see any games with your KDA less than 30/4/0,
                it's time to make a stand. Penetrate the souls of these weak
                minded individuals who can play their champs with their left
                foot and do more damage than you. Get onto the rift and start
                one hitting people.
              </p>
              <h4 className="font-semibold">NO EXCUSES.</h4>
            </div>
            <div class="w-full sm:w-1/2 p-6">
              <svg
                class="w-full sm:h-64 mx-auto"
      ...
      <section class="relative container mx-auto text-center py-6 mb-12">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center">
          Women will play on you like a jungle gym.
        </h1>
        <div class="w-full mb-4">
        ...
        <h3 class="my-4 text-xl leading-tight">
          Yes, all you have to do is click the button below...
        </h3>
        ...
        <img
          class="absolute -mt-20 md:-mt-32 left-0 w-24 md:w-32 z-50"
          src="/assets/Draven_Render.png"
          style={{ transform: 'scaleX(-1)' }}
        />
        <img
          class="absolute -mt-20 md:-mt-32 right-0 w-24 md:w-32 z-50"
          src="/assets/Draven_Render.png"
        />
      </section>
